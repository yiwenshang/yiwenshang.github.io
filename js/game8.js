...
Chip.prototype.splash = function (pos, scale) {
  ...
  //   var targetX = pos.x + (-1 + Math.random() * 2) * 0.5;
  //   var targetY = pos.y + (-1 + Math.random() * 2) * 0.5;
  var targetX = pos.x + 0.5;
  var targetY = pos.y - 0.5;
  ...
  TweenMax.to(this.mesh.position, speed, {
    ...
    onComplete: function () {
      ...
      chipPool.unshift(_this); //add element in the begin of the array
    },
  });
};
...
function update() {
  ...
  if (markerControls1.object3d.visible && markerControls2.object3d.visible) {
    ...
    if (
      ...
      chipHolder.spawnChip(smoothedRoot_ham.position, 2);
