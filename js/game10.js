...
var Plate = function () {
  ...
  loader.load("font/helvetiker_regular.typeface.json", function (response) {
    ...
    //combo num
    var fontGeo_num = new THREE.TextGeometry(num_text, fontConfig);
    fontGeo_num.computeBoundingBox();
    var font_num = new THREE.Mesh(fontGeo_num, material_num);
    font_num.position.set(-2.4, 2.9, 0.2);
    smoothedRoot_drum.add(font_num);
    //beat
    var fontGeo_beat = new THREE.TextGeometry(beat_text, fontConfig);
